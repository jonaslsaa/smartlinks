/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c681f26b0baf605b6e8ca14b66dc6cd9)
// Runtime types generated with workerd@1.20260814.1 2026-08-14 nodejs_compat
interface __BaseEnv_Env {
	EXECUTION_RATE_LIMITER: RateLimit;
	IDENTITY_RATE_LIMITER: RateLimit;
	ACTIVE_KEY_ID: "1";
	AUTHOR_CA_KEY_ID: "1";
	AUTHOR_CA_PUBLIC_KEY_1: "iIakS3SEmbDXHtqGGsDhiQTGgx8yB9G6orxyHyqAIwc";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACTIVE_KEY_ID" | "AUTHOR_CA_KEY_ID" | "AUTHOR_CA_PUBLIC_KEY_1" | "LANDING_URL" | "RUNTIME_HOSTNAMES">> {}
}
declare module "*.wasm" {
